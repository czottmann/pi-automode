...
- **Classifier cost in the status line** — Accumulate Pi's classifier usage cost across fast, detailed, and retry attempts, and show the current session total alongside classifier decision counts.
